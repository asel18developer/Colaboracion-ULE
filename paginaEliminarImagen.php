...
<body>
  ...
  <header>
    ...
    <ul id="gestion_imagenes" class="dropdown-content">
      ...
      <li class="active"><a href="#">Eliminar imagenes</a></li>
  ...
  <nav class="teal" role="navigation">
          ...
          <ul class="collapsible collapsible-accordion">
            <li>
              ...
              <div class="collapsible-body">
                <ul>
                  <li><a href="paginaSubirImagen.php">Subir imagenes</a></li>
                  <li class="active teal lighten-2"><a href="#">Eliminar imagenes</a></li>
                  <li><a href="paginaModificarImagen.php">Modificar imagenes</a></li>
                </ul>
              </div>
            </li>
    ...
    <main>
      ...
      <h4 class="center teal-text">Eliminar imagenes.</h4>
      <div class="container">
        <!-- Modal Structure -->
        <div id="modal1" class="modal">
          ...
          <p>
            ...
            <ul>
              <li>Se pueden eliminar varias imagenes y/o carpetas a la vez.</li>
                <li>Para navegar por los diferentes directorios de imagenes,
                  se ha de pinchar sobre estas.</li>
                  <li>Si se borra una carpeta todo su contenido sera eliminado.</li>
          ...
          <form class="amplio" name="myForm" action="eliminarImagenes.php"
...
function mostrarImagenesEliminar(){
  ...
  //while($usuario = mysqli_fetch_array($queryUsuario)){
    ...
    foreach($archivos as $archivo)
    {
      ...
      echo "<a style='position: relative;' href=\"paginaEliminarImagen.php?directorio=".$directory."/".$archivo."\"><img class='miniatura' src=img/carpeta.png><img src='".obtenerImagen($directory."/".$archivo)."'></a>";
      echo "<input id=\"".$directory."/".$archivo."\" type=\"checkbox\" name=\"imagenesEliminar[]\" value=\"".$directory."/".$archivo."\"/>";
...
function mostrarIconosCasaReturn(){
  ...
  if(strcmp ($directory,"Repositorio")!=0){
    ...
    echo('<div  id="floatHome">
          <a href="paginaEliminarImagen.php" class="btn-floating btn-large teal">
            <i class="material-icons">home</i>
          </a>
        </div>');
    echo('<div  id="floatBack">
          <a href="paginaEliminarImagen.php?directorio='.dirname($directory).'"

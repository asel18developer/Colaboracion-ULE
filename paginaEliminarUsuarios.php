...
<body>
  ...
  <header>
    ...
    <ul id="gestion_imagenes" class="dropdown-content">
      ...
      <li><a href="#!">Modificar imagenes</a></li>
    </ul>
  ...
  <ul class="collapsible collapsible-accordion">
    <li>
      ...
      <div class="collapsible-body">
        <ul>
          <li><a href="paginaAdministrador.php">Registrar usuarios</a></li>
          <li class="active teal lighten-2"><a href="#">Eliminar usuarios</a></li>
          <li><a href="paginaSeleccionUsuarios.php">Modificar usuarios</a></li>
        </ul>
      </div>
    </li>
...
<br>
    ...
    <div class="container">
              ...
              <div id="modal1" class="modal">
                ...
                <h4>Ayuda eliminar usuarios</h4>
                  <p>Para eliminar usuarios debes marcar cada uno de los usuarios que quieres eliminar.</p>
                </div>
                ...
                <form name="myForm" action="eliminarUsuarios.php"
                   ...
                   <div class="col s12 m12 l8 offset-l2">
                     <div class="card grey lighten-4">
                       <div class="card-content black-text">
                         <h5 class="center teal-text">Eliminar usuarios</h5>

                         <div class="row  contenerdorFormularios">
                  <?php
...
function mostrarUsuariosEliminar(){
  ...
  while($usuario = mysqli_fetch_array($queryUsuario)){
    ...
    echo'<div class ="usuario"><input type="checkbox" name="usuariosEliminar[]" id="'.$usuario['nombre_usuario'].'"
    value="'.$usuario['nombre_usuario'].'">
      <label class = "userName" for="'.$usuario['nombre_usuario'].'">'.$usuario['nombre_usuario'].'</label>';

    echo ('<p><br><b>Nombre de usuario:</b> ' .
    $usuario['nombre_usuario'] . '<br><b>Tipo de Usuario: </b>'. $tipoUser.
    '</p> <b>Nombre:</b> '.$usuario['nombre'].'<br><b>Apellidos: </b>'.$usuario['apellidos'].
    '</div>');
    echo ("<br>");
